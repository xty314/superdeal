...
void Page_Load(Object Src, EventArgs E ) 
{
	...
	Response.Write("<tr><td colspan=2><input type=checkbox name=item value=1 checked>Product &nbsp;&nbsp;</td></tr>");
...
bool DoExport()
{
	string sc = " SELECT supplier_code, name, level_price0 AS price, barcode ";
