...
//		Response.Write(" rmsg = window.prompt('Are you sure you want to delete this order?')\r\n");
	...
	else if(Request.Form["cmd"] == Lang("Apply Total") || (Request.Form["discount_total"] != null && Request.Form["discount_total"] != ""))
	{
...
//	DEBUG("tabwl =", tableWidth);
	...
	Response.Write("<tr style=\"color:white;background-color:#666696;font-weight:bold;\">\r\n");
	Response.Write("<td id='table-list-title-format width=130' align=left width=15%>"+ Lang("STOCK ID") +"</td>");
	...
	Response.Write("<td align=right>"+ Lang("TOTAL") +"</td></tr>");
...
*/
	...
	//Response.Write("<tr bgcolor=#ffffff><td colspan=" + (m_cols-1).ToString() + " align=right>");
	Response.Write("<td  bgcolor=#EEEEE colspan=3 align=right>");
	Response.Write("<b>"+ Lang("Total Amount Due") +" : </b></td>");
	Response.Write("<td bgcolor=#EEEEE align=right><b>");
...
///total discount in price//
	...
	*/
	...
	Response.Write("<span style=\"font:bold 15px arail\">($) </span><input type=text name=discount_total size=5 maxlenth=8 style=text-align:right>");
...
//	Response.Write("<input type=hidden name=sales value='" + m_sales + "'>");
	...
	if(m_cCustGst == "0.125" )
	 Response.Write(" selected ");
	Response.Write(" selected > 12.5  </option>");
