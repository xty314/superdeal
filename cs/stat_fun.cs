...
//	DEBUG("ntaot+", nTotalMonth);
	...
	//	sc += " AND (ROUND(i.total,2)-ROUND(i.amount_paid,2)) > 0.0099  ";
		...
		if(Request.QueryString["selected_invoice"] != "" && Request.QueryString["selected_invoice"] != null)
		{
			sc += " AND i.invoice_number in (" + Request.QueryString["selected_invoice"] + ") ";
		}
...
{
    int pagepdf = 1;
    string logo = ReadSitePage("statement_pdf_logo_1");
    string statlisttitle = @"<br><table width=90% align=center cellspacing=0 cellpadding=0 border=0 bordercolor=#EEEEEE bgcolor=white  >
		<tr bgcolor=#4080BF >
			<td width=15% align=center><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;' >Date</font></td>
			<td width=18% align=center><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;' >Invoice no.</font></td>
			<td width=17% align=center><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;' >Order no.</font></td>
			<td width=15% align=right><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;' >Charges</font></td>
			<td width=15% align=right><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;' >Payment</font></td>
			<td width=20% align=right><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;' >Total &nbsp;</font></td>
		</tr>";
    string custAdd = @"
						<table width=90% cellpadding=0 cellspacing=0 border=1 align=center >
					  <tr >
						<td align=left ><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;' >
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;@@compname</font>
						<font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;' >
						<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;@@pobox 
						<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;@@suburb 
						<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;@@city</font><br> 
						</td></tr></table>";
    ...
    string statHeader = ReadSitePage("statement_pdf_header_1");
    ...
    sb.Append("<html><body>\r\n");
    sb.Append(logo);
    sb.Append(statHeader);
    sb.Append(custAdd);
    sb.Append(statlisttitle);
    
    double totalDue = 0;
					
	string statFooter = ReadSitePage("statement_pdf_footer_1");
    ...
    for(int e = 0; e < dst.Tables["invoice_rec"].Rows.Count; e++)
	{
		...
		string item = @"<tr><td align=center><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;' >";
		item +=  DateTime.Parse(dr["commit_date"].ToString()).ToString("dd/MM/yy");
		item += @"</font></td>";
		string inv_number = dr["invoice_number"].ToString();
		if(inv_number == "0")
		    inv_number = "";
		item += @"<td align=center><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;' >";
		item += inv_number;
		item += @"</font></td>";
		if(dr["cust_ponumber"].ToString() == "")
		    item += "<td align=center>&nbsp;</td>";
		else
			item += "<td align=center><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;' >" + dr["cust_ponumber"].ToString() + "</font></td>";
		item += "<td align=right><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;'>" + double.Parse(dr["total"].ToString()).ToString("c")  + "</font></td>";
		if(dr["amount_paid"].ToString() == "0")
		    item += "<td align=right>&nbsp;</td>";
		else
			item += "<td align=right><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;' >" + double.Parse(dr["amount_paid"].ToString()).ToString("c")  + "</font></td>";
	    item += "<td align=right><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;' >" + double.Parse(dr["cur_bal"].ToString()).ToString("c") + "</font></td>";
		item += "</tr>";
		...
		if(e==14 && sRows>15)
		{
			...
			sb.Append("<table ><tr bgcolor=#4080BF ><td align=right><b><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;' >");
            sb.Append("STATEMENT TOTAL:&nbsp;&nbsp;</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>");
            sb.Append("<font face='Times New Roman, Times, serif' color=#FFFFFF size=10px align=right >"+totalDue.ToString("c")+"</FONT></td></tr></table>");
			sb.Append(statFooter);
							
			sb.Append("<br><br><table cellpadding=0 cellspacing=0 border=0 width=90% align=center ><tr><td align=left valign=middle >");
			sb.Append("<font style='font-family:Arial Black, Gadget, sans-serif; font-weight:bold; font-size:55px'>STATEMENT</font></td><td>&nbsp;</td>");
	      	sb.Append("<td align=right valign=bottom ><table cellpadding=0 cellspacing=0 border=1 border-color=#000000>");
			sb.Append("<tr><td bgcolor=#4080BF  height=10   valign=middle height=10px >");
            sb.Append("<font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px; color:#FFFFFF' >Page:</font>&nbsp;</td>");
			sb.Append("<td align=left><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;' >2 of "+totalPage+"</font></td>");
			sb.Append("<tr><td bgcolor=#4080BF  size=220 ><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;color:#FFFFFF' >");
            sb.Append("Statement Date:</font>&nbsp;</td>");
			sb.Append("<td align=left><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;'  >");
			sb.Append(System.DateTime.Now.ToString("dd-MMM-yyyy"));
			sb.Append("</font></td><tr></table></td></tr></table>");
			sb.Append(custAdd);
			sb.Append(statlisttitle);
		}
	...
	if(rest > 0)
	{
		...
		{
		    sb.Append("<tr><td colspan=6><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;' >&nbsp; </font></td></tr>");
		}
	}
	if(rest < 0)
	{
	...
	if(rest != 0)
	{
	    sb.Append("<table cellpadding=0 cellspacing=0 border=0 width=90% align=center><tr bgcolor=#4080BF ><td align=right><b><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;'>");
        sb.Append("STATEMENT TOTAL:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><font style='font-family:Times New Roman, Times, serif; font-weight:bold; font-size:15px;' >");
        sb.Append(totalDue.ToString("c")+"</font></td></tr></table>");
		statFooter = statFooter.Replace("@@date",  DateTime.Now.ToString("dd-MM-yyyy"));
	    sb.Append(statFooter);
	}
    sb.Append("</body></html>");
...
bool GetSubBalance(int i, string sCardID, ref double dtotal)
{
	...
	if(!bCardType(ref sCardID))
	{
		...
		else if(m_scredit_terms_id == "btm") // ** before this month
		{
			if(i == 0)
				sc += "	AND DATEDIFF(month, commit_date, GETDATE()) = 1 ";
			else if(i == 1)
				...
				sc += " AND DATEDIFF(month, commit_date, GETDATE()) >= 4";
			else
			{
				dtotal = 0.00;
				return true;
...
//DEBUG("sc =", sc);
	...
	return dst.Tables["cust_gen"].Rows[0][field].ToString();
...
String PrintStatmentDetailsPDF(string selected)
{
	...
	int nStoreID = 0;
	if(pickMonth != "all" && pickMonth != null && pickMonth != "" && pickMonth != "btm")
	{
		nStartCount = int.Parse(pickMonth);
