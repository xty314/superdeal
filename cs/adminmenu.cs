...
////put left image for the menu, using mleft.jpg
		...
		//catalog table
		/*s += "\r\n<td width=100px class=mc align=center nowrap id=m" + name + " onmouseover='setMenu(\"m" + name + "\", \"" + name + "Menu\")'>";
...
//			s += "<font color=#AAAAAA><b>" + name + "</b></font>";
		...
		s += "\r\n<td width=100px class=mc align=center nowrap id=m" + name + " onmouseover='setMenu(\"m" + name + "\", \"" + name + "Menu\")'>";
		//s += "<a href=default.aspx?ms="+ cat +" class=w><img height=20 src=../i/icon/" + name + ".png border=0><b>&nbsp;" + name + "</b></td>";
		s += "<a href=\"javascript:void(0)\" class=w><img height=20 src=../i/icon/" + name + ".png border=0><b>&nbsp;" + name + "</b></td>";
		s += "<td class=mr nowrap></td>";
	}
