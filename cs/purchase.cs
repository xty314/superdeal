...
//DEBUG("branch_support=", Session["branch_support"].ToString());
		if(Session["branch_support"] != null)
//        if(MyBooleanParse(Session["branch_support"].ToString()))
		{
...
//              Response.Write("<input type=button value='Dispatch' onclick=window.location=('dispatch.aspx?n=" + m_poID);
			    Response.Write("')  "+ Session["button_style"] +" >");
			}
