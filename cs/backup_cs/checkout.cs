...
{  
   ...
   if(Cache["item_categories"] != null)
	...
	Response.Write("<br><br><input type=button onclick=window.location=('checkout.aspx?t=at&r=" + DateTime.Now.ToOADate() + "') value='I have read and agree, and I am over 18 years old' class=b>");
...
//		sb.Append("New Zealand");
	...
	{
		sb.Append("<TR><TD  Style=\"font:bold 13px arail; color:#6699CC; text-align:left\">EMail<font color=red>*</font></font></TD><TD><INPUT NAME=email VALUE='");
		sb.Append(dr["Email"]);
		sb.Append("' SIZE=30 MAXLENGTH=40></TD></TR>\r\n");
		sb.Append("<TR><TD  Style=\"font:bold 13px arail; color:#6699CC; text-align:left\">Confirm<font color=red>*</font></TD><TD><font size=2><I>(type email address again)</I></font></TD></TR>\r\n");
	...
	sb.Remove(0, sb.Length);
	if(!TS_UserLoggedIn()){
	sb.Append("<fieldset><legend style=\"font:bold 15px arial;color:#6699CC\">Ruturning Customer Login</legend>");
	sb.Append("<table width=800 height=50 cellpadding=0 cellspacing=0 border=0   >");
	sb.Append("<tr>");
	sb.Append("<td  Style=\"font:bold 13px arail; color:#6699CC; text-align:left\" >LoginEmail :");
	...
	sb.Append("<input type=password name=pass size=22 class=LoginField ></td>");
	sb.Append("<td  height=28 align=center  >");
	sb.Append("<input type=submit name=cmd value='Login' /></td>");
	sb.Append("</tr></table>");
	sb.Append("</fieldset>");
	}
	else{
	...
	sb.Remove(0, sb.Length);
	sb.Append("<H3  Style=\"font:bold 18px arail; color:#6699CC; text-align:left\">Billing Address</H3><TABLE BORDER=0>\r\n");
...
//		sb.Append("New Zealand");
	...
	//sb.Append("<TR rowspan=2><TD colspan=2><font size=2 color=darkblue><b>* leave billing address blank if same as shipping address<b /></font></TD></TR>\r\n");
