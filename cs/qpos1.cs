...
// no gst for the qpos
	...
	m_gst = MyDoubleParse(GetSiteSettings("gst_rate_percent", "1.15")) / 100;
	if(m_gst < 1)
		m_gst = 1 + m_gst;
...
bool PrintMassInterface()
{
	...
	if(m_bTrustedSite)
	{
		sb.Append("\r\n<object classid=\"clsid:B816E029-CCCB-11D2-B6ED-444553540000\" ");
   		sb.Append(" CODEBASE=\"asprint.ocx#version=1,1,0,6\" ");
...
//		sb.Append("<td><input size=10 name=st" + i + " class=f onchange=\"cs(" + i + ");\"><input type=hidden name=np" + i + ">");
		sb.Append("<td wrap valign=middle width=10%><input size=9 "+ rowColor +" name=st" + i + " class=f onclick=this.select(); onfocus=\"sh(this);\" onblur=\"rh(this);\" onchange=\"cs(" + i + ");\" style=\"position: relative; top: 0\">");		
		sb.Append("<input type=button "+ setStyle +" name=del" + i + " value=' X ' onclick=\"del(" + i + ")\" class=b style=visibility:hidden>");
...
//		s += " var s_display = 'Welcome to " + m_sCompanyTitle + "'; \r\n";
		...
		s += " document.AsPrint1.PrintString('" + sclear + smoveleftmost + "');\r\n";
...
";
	if(m_bDisplay)
	{
		...
		s += " document.AsPrint1.Open('" + m_sDisplayPort + "')\r\n";
//		s += " document.AsPrint1.PrintString('" + ssdisplay + sclear + smovehome + smoveleftmost + "');\r\n";
		s += " document.AsPrint1.PrintString('" + ssdisplay + sclear + smoveleftmost + "');\r\n";
		s += " document.AsPrint1.PrintString(s_display);\r\n";
		s += " document.AsPrint1.Close();\r\n";
	}
...
//	s += " var s_d_desc = 'Change : '; \r\n";
	...
	s += " document.AsPrint1.Open('" + m_sDisplayPort + "')\r\n";
//	s += " document.AsPrint1.PrintString('" + ssdisplay + sclear + smovehome + smoveleftmost + "');\r\n";
	s += " document.AsPrint1.PrintString('" + ssprinter + sclear + smoveleftmost + "');\r\n";
	s += " document.AsPrint1.PrintString(s_display);\r\n";
	s += " document.AsPrint1.Close();\r\n";
}
s += @"
...
//		sprint +=  kickout;// + "\\r\\n";
	...
	s += "tf.Close();\r\n";
//	s += "	document.AsPrint1.Open(document.f.printer_port.value);\r\n";
	s += "	document.AsPrint1.Open(sport);\r\n";
