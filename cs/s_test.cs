...
[System.Web.Services.WebServiceBindingAttribute(Name="testSoap", Namespace="http://eznz.com/")]
class csTest : System.Web.Services.Protocols.SoapHttpClientProtocol
{
    public csTest(string Url)
    {
        this.Url = Url;
    }

    [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://eznz.com/Add", RequestNamespace="http://eznz.com/", ResponseNamespace="http://eznz.com/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
