...
string m_branchID = "1";
string m_tableTitle = "Stock In/Out Trace ";
string m_datePeriod = "";
string m_dateSql = "";
string m_code = "";
...
void PrintMainPage()
{
	Response.Write("<form action=stockinouttrace.aspx method=post>");
	...
	Response.Write("<tr><td><b>" + Lang("Item Code") + " : </b><input type=text size=10 name=code value=" + m_code + "> ");
	if(Session["branch_support"] != null)
	{
	...
	Response.Write("<tr><td colspan=2 align=right><input type=submit name=cmd value='" + Lang("Trace") + "' class=b></td></tr>");
...
void PrintStockTrace()
{
	...
	string sc = " SELECT q.qty AS stock, q.allocated_stock, c.supplier_code, c.name ";
...
//DEBUG("sc ", sc);
	...
	Response.Write("<form action=stockinouttrace.aspx?p=" + m_nPeriod + "&c=" + m_code + " method=post>");
...
//	Response.Write("<th align=right>" + Lang("Balance") + "</th>");
	...
	Response.Write("<font color=green><b>" + Lang("Start Date") + "</b></font></td><td colspan=3 align=right></td></tr>");
...
//		Response.Write("<td align=right>" + nAfter.ToString() + "</td>");
	...
	Response.Write("<font color=green><b>" + Lang("Finish Date") + "</b></font></td><td colspan=3 align=right></td></tr>");
...
void PrintAllocatedTrace()
{
	...
	Response.Write("<tr style=\"color:black;background-color:yellow;font-weight:bold;\">");
	Response.Write("<td>" + start_date + "</td><td>&nbsp;</td><td>");
	Response.Write("<font color=green><b>" + Lang("Start") + "</b></font></td><td colspan=3 align=right>" + obalance + "</td></tr>");
	...
	Response.Write("<tr style=\"color:black;background-color:yellow;font-weight:bold;\">");
	Response.Write("<td>" + date + "</td><td>&nbsp;</td><td>");
	Response.Write("<font color=green><b>" + Lang("Finish") + "</b></font></td><td colspan=3 align=right>" + m_nAllocated + "</td></tr>");
