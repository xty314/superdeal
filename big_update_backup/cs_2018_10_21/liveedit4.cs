...
//	Response.Write("</td></tr>");
	...
	//BARCODE
	Response.Write("<tr><td><b>"+Lang("Barcode:")+"</b></td><td ><input type=text maxlength=20 size=30 name=barcode ");
...
//	Response.Write(" onclick=\"if(document.form1.barcode.value == ''){window.alert('Please enter barcode');return false;}\"");
	...
	Response.Write("<tr bgcolor='#EEEEE'><td colspan=2><font size=3><b>"+Lang("Last Cost Details")+"</b></font></td></tr>");
	Response.Write("<tr>");
/*********************************/
...
*/ 
	...
	Response.Write("<tr bgcolor='#ffffff'><td colspan=2><font size=3><b>"+Lang("POS Prices")+"</b></font></td></tr>");	
	Response.Write("<tr><td>");
