...
//			Response.Write(" readonly=true");
	...
	Response.Write("<tr><td bgcolor=#eeeeee align=center>");
	Response.Write("<font color=red>Physical Address</font></td><td><input type=text size=20 name=address1 maxlength=30  onkeyDown=\"this.style.backgroundColor='#FFFFFF'\" value='");
	...
	{
		Response.Write("<font>Fax Number</font></td><td>");
	}
	...
	else
	{
		...
		if(newType !="employee" && sType !="EMPLOYEE" && newType !="customer" && sType !="CUSTOMER" && newType !="otherse" && sType !="OTHERS" && m_sSite != "www")
		{
			Response.Write("<tr><td bgcolor=#eeeeee align=center>");
	...
	Response.Write("</td></tr>");
	Response.Write("</table></td>");
	Response.Write("<tr><td colspan=3 align=center><br>");
