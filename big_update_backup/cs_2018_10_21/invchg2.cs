...
//		sales_price *= 1.125;
	...
	Response.Write("<tr align=right><th colspan=6><b>SUB TOTAL :</b></th><td style=\"width:150px\"> <input width=15px style='text-align: right' type=text name=subtotal readonly=readonly value='"+ d_sub_total.ToString("c") +"'></td></tr>");
...
sc += " UPDATE invoice set agent ="+ agent +", price = "+ sub_total +", tax = "+ tax +", customer_gst = "+ customer_gst +", total = "+ price_total +" where invoice_number = "+ m_invoice_number;
